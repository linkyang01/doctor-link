...
- ADR: `docs/adr/0006-p6-standardization-ecosystem-roadmap.md`

P6 是未来阶段路线图。未获得明确授权前，不启动 P6 实现开发。

---

## P6.1 Diagnostic Package Schema v1

- [ ] 定义 `doctor-report.json` JSON Schema
- [ ] 定义 `ai-context.json` JSON Schema
- [ ] 定义 `user-assertions.json` JSON Schema
- [ ] 定义 `verification-result.json` JSON Schema
- [ ] 定义 `manifest.json` JSON Schema
- [ ] P3 完成后定义 `ai-repair-result.json` JSON Schema
- [ ] P3 完成后定义 `diagnosis-history.json` JSON Schema
- [ ] 定义 package schema version 字段
- [ ] 定义 schema compatibility policy
- [ ] 定义 schema migration policy
- [ ] 规划 schema validation command
- [ ] 增加 schema validation fixtures
