...
P6 已完成 P6.1 schema 标准化、P6.2 本地兼容性与一致性测试套件、P6.3 Adapter SDK 规划规范、P6.4 Plugin SDK 规划规范、P6.5 第三方 AI Coding 集成规范、P6.6 签名与完整性规划规范、P6.7 隐私与安全分级规范、P6.8 企业归档与治理模型规范、P6.9 跨项目诊断知识库规范。当前不启动 Web 平台、云服务、账号体系、市场平台、真实知识库服务、真实第三方集成、真实签名实现、真实权限系统、企业归档系统、Adapter SDK 运行时或 Plugin SDK 运行时。
