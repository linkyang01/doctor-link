...
PROFILES: dict[str, HandoffProfile] = {
    ...
    "grok": HandoffProfile(
        ...
        "GROK_TASK.md",
        [
            "Use this task as the Grok Build session objective (`grok` TUI or headless agent).",
            "Inspect package evidence before editing; cite evidence IDs in the repair summary.",
            "Run verification commands locally before claiming the issue is fixed.",
        ],
        preferred_context="agentic-cli",
        max_recommended_files=36,
    ),
    "windsurf": HandoffProfile(
        "windsurf",
        "Windsurf",
        "WINDSURF_TASK.md",
        [
            "Use this task with Windsurf Cascade in the workspace containing the source project.",
            "Keep changes inside the investigation boundary and reference copied evidence files.",
        ],
        preferred_context="chat-plus-workspace",
        max_recommended_files=28,
    ),
    "cline": HandoffProfile(
        "cline",
        "Cline",
        "CLINE_TASK.md",
        [
            "Attach or reference the copied package files in a Cline chat.",
            "Ask Cline to read evidence before editing and to run the listed verification commands.",
        ],
        preferred_context="ide-context",
        max_recommended_files=24,
    ),
