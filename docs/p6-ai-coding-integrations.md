...
## Grok Build integration specification

Grok Build handoff should emphasize:

- agentic CLI or IDE session objective;
- evidence-backed diagnosis and user assertions;
- investigation boundary and verification commands;
- local-first execution before closure.

Grok Build integration should warn when evidence is incomplete or when verification has not been run.

## Windsurf integration specification

Windsurf handoff should emphasize:
...
Windsurf integration should warn when package evidence cannot be attached to the workspace session.

## Cline integration specification

Cline handoff should emphasize:

- chat-attached context files;
- concise problem statement;
- files to inspect;
- test commands;
- human review requirements.

Cline integration should avoid suggesting edits outside the declared investigation boundary.
