...
版本 [`v0.3.0`](https://github.com/linkyang01/doctor-link/releases/tag/v0.3.0) 已正式发布。JavaScript/TypeScript 自动解决和运行时韧性增强已通过本地 339 项测试、85.48% 分支覆盖率、安装后 wheel 的 72 次全能力调用与 10 组复杂场景，并完成一次保护验收输入不变的真实 Node.js 修复。[GitHub Actions 运行 29299016223](https://github.com/linkyang01/doctor-link/actions/runs/29299016223) 已对最终提交通过全部 10 个作业，覆盖 Python 3.10–3.14、安全、构建，以及 Ubuntu、macOS、Windows。PR `#147` 合并为 `e0224cc`，[发布工作流 29299367180](https://github.com/linkyang01/doctor-link/actions/runs/29299367180) 已创建标签并上传资产，PyPI 保持关闭。详见[JavaScript/TypeScript 自动解决验证报告](../validation/javascript-typescript-solve-validation.md)。
