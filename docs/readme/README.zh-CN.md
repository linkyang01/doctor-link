...
Doctor link 仍然坚持本地优先。源码版本 `0.1.2` 已在 2026-07-13 通过修复后的本地验证和 GitHub Actions 全矩阵验证：273 项测试、85.09% 分支覆盖率、Python 3.10–3.12、Ubuntu/macOS/Windows、安全检查、构建与隔离安装均通过。100 分认证运行见 [Actions 29221918410](https://github.com/linkyang01/doctor-link/actions/runs/29221918410)，按既定仓库发布就绪口径评分为 100/100。`v0.1.2` 尚未发布为 GitHub Release；CI 通过不等于获得发布授权。项目不创建托管平台、不引入外部账号体系、不做遥测、不提供 marketplace。
