...
版本 [`v0.5.1`](https://github.com/linkyang01/doctor-link/releases/tag/v0.5.1) 是当前最新正式版本，是自然语言问题复现、`doctor-link assist` 引导入口和 24 项 Python/Node.js 长期基准的分发一致性补丁。

Doctor link 仍然坚持本地优先。v0.5 系列已通过 365 项测试、全部 66 个安装后 CLI 入口、75 次真实调用、12 个复杂场景，以及 Python 3.10–3.14、Ubuntu/macOS/Windows、安全检查、构建、隔离安装、Trusted Publishing 和全新 pipx 安装。
