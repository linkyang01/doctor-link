...
版本 [`v0.4.0`](https://github.com/linkyang01/doctor-link/releases/tag/v0.4.0) 已正式发布，提供 Monorepo 子包定位、中断恢复和多项目基准。当前 `v0.5.0` 源码进一步增加自然语言问题复现、`doctor-link assist` 引导入口和 24 项 Python/Node.js 长期基准；用户不再必须理解测试命令。
