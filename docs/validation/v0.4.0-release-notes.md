...
Controlled interrupted-session tests cover fresh approval, successful continuation, branch mismatch, and protected-input drift. Cloud CI remains the release gate; this document must be updated with immutable evidence before publication.
