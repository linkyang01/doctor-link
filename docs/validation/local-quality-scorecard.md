...
| Reliability and tests | 20 | 20 | 319 tests pass with 85.39% branch-aware coverage and an enforced 85% floor across Python 3.10, 3.11, and 3.12 cloud jobs; 63/63 public routes pass through 71 installed-package invocations and nine complex scenarios. |
...
- full capability lab: `63/63` public routes, `71` real invocations, `9` complex scenarios
- GitHub Actions run [`29256743976`](https://github.com/linkyang01/doctor-link/actions/runs/29256743976): passed
- cloud jobs: Python 3.10, 3.11, 3.12, security, package install, Ubuntu, macOS, and Windows all passed

## Certification boundary

The release candidate commit passed the complete configured cloud matrix in PR `#145`. The PR was later merged as commit `40a547c`; after explicit authorization, [GitHub Release `v0.2.0`](https://github.com/linkyang01/doctor-link/releases/tag/v0.2.0) was published by workflow `29256955705`. PyPI publication was disabled and not performed.
