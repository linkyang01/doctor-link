...
- Pull request: [#140 Release v0.1.3 reliability and export hardening](https://github.com/linkyang01/doctor-link/pull/140)
- Release candidate commit: `4119f0ec414c40d95770903cdc7137981b87ed36`
- Final PR CI run: [29245883700](https://github.com/linkyang01/doctor-link/actions/runs/29245883700)
- Merge commit: `fa779dada6b699aab7c969435440d189232235bd`
- Release workflow: [29246045227](https://github.com/linkyang01/doctor-link/actions/runs/29246045227)
- Published release: [v0.1.3](https://github.com/linkyang01/doctor-link/releases/tag/v0.1.3)
- Conclusion: `success`
- Date: 2026-07-13
...
- Ruff static checks;
- 298 automated tests;
- 85.25% branch-aware coverage with an 85% minimum;
...
- installed-wheel full capability validation covering 62/62 routes, 70 real invocations, and eight complex scenarios;
...
| Installed-wheel full capability lab | 62/62 routes, 70 invocations, 8 scenarios |
...
GitHub Release `v0.1.3` was published on 2026-07-13. Its annotated tag resolves to merge commit `fa779dada6b699aab7c969435440d189232235bd`.

| Asset | Size | SHA-256 |
| --- | ---: | --- |
| `doctor_link-0.1.3-py3-none-any.whl` | 160,217 bytes | `ad4760f5c0ab28f3a8e0407f766e9dfedd21e31d94f377274b96a42d7868e497` |
| `doctor_link-0.1.3.tar.gz` | 350,835 bytes | `f3fe2e4efebefb350cd0c50885fa9304e8b5683ea901f7a98d6d9e34c7ae3ba9` |
...
Version `v0.1.2` was published from merge commit `862281f38af6550a149a45fbf002560302e6423b` by workflow `29223309411`. It remains valid historical release evidence but does not replace the current `v0.1.3` certification.
